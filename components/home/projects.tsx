  ...
  const renderSectionTitle = (): React.ReactNode => (
    ...
    >
      ...
      <h2 className="text-2xl md:max-w-3xl w-full seq max-w-sm mt-2">
        Diverse, I have contributed in over 10+ projects ranging from writing a compiler in assembly and C++ to desigining an Angular application to visualise financial instruments.
      </h2>
    </div>
  );
