...
const AboutSection = () => {
  ...
  const renderQuotes = (): React.ReactNode => (
    <h1 ref={quoteRef} className="font-medium text-3xl sm:text-4xl md:text-6xl">
      ...
      >
        Curious, I constantly learn new languages and skills to better my ability as an Electronics Engineer.{" "}
      </span>
      <span
      ...
      >
        I enjoy working in teams and finding innovative solutions that save companies time, money and effort.
      </span>
    </h1>
  );
