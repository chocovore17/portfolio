  ...
  const renderSectionTitle = (): React.ReactNode => (
    <div className="flex flex-col">
      ...
      <h2 className="text-2xl md:max-w-2xl w-full seq mt-2">
        I have fun building solutions for any client! My diverse background keeps me open for.{" "}
      </h2>
    </div>
  );
    ...
    <section className="relative">
      ...
      >
        ...
        <div className="flex flex-col skills-wrapper">
          {renderSectionTitle()}
          <div className="mt-10">
            {renderSkillColumn("PROGRAMMING LANGUAGES", SKILLS.programming)}
          </div>
          <div className="flex flex-wrap mt-10">
            <div className="mr-6 mb-6">
              {renderSkillColumn(
            ...
            <div>{renderSkillColumn("LANGUAGES", SKILLS.languages)}</div>
